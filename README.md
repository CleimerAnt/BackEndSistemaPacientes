Este es un proyecto desarrollado con Node.js, en el cual utilizo una base de datos relacional SQL con el gestor MySQL. Para la gestión de datos, relaciones y creación de tablas, empleo Prisma como ORM.
